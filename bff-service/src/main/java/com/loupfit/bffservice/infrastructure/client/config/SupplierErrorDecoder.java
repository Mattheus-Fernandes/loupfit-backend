...
public class SupplierErrorDecoder implements ErrorDecoder {
    ...
    public Exception decode(String s, Response response) {
        ...
        switch (response.status()) {
            case 409:
                return new ConflictException("Fornecedor já cadastrado");

            case 404:
                return new ResourceNotFoundException("Fornecedor não encontrado");
